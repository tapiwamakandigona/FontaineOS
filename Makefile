...
bin/fontaineos.bin: src/boot.o src/kernel.o src/gdt.o src/idt.o src/timer.o
	$(LD) $(LDFLAGS) -o bin/fontaineos.bin src/boot.o src/kernel.o src/gdt.o src/idt.o src/timer.o
